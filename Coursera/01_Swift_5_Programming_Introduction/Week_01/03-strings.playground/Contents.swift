...
var streetAddress = "1 Universal Road"
var city = "Zanarkand"
var state = "Spira"
var zip = "101010"
let idNumber = "77721"
...
let output = """
Hi, my name is \(name), and I was born on \(dateOfBirth). I'm \(ageVal) years old.
I live at \(streetAddress), \(zip) in \(city), \(state).
My id number is \(idNumber). I \(isOrganDonor ? "am" : "am not") an organ donor.
"""
